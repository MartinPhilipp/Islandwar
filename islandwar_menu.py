menu_e = {"main":       ["Play", "Tutorial", "Levels", "Campaign", "Multiplayer", "Help", "Credits", "Settings","End the game"],
        ...
        "Multiplayer":["back", "1 player vs. 1 player", "2 player vs. 2 player"],
...
menu_d = {"main":       ["Play", "Tutorial", "Levels", "Kampagne", "Mehrspieler", "Hilfe", "Entwickler", "Einstellungen","Beenden"],
        ...
        "Mehrspieler":["zurück", "1 Spieler vs. 1 Spieler", "2 Spieler vs. 2 Spieler"],
        "Hilfe":       ["zurück", "Hauptinsel", "Holzinsel", "Eiseninsel", "Werftinsel",],
        "Entwickler":    ["zurück", "Ines Schnabl", "Martin Schnabl", "Julia Steger","Marcel Korinek"],
        "Einstellungen":   ["zurück", "Sprache", "Geschwindigkeit", "Auflösung", "Vollbildschirm", "Grafik"],
